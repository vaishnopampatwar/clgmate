    ...
    <div style={{ width: "100%" }}>
      ...
      >
        ...
        >
          ...
          <div className="p-4" style={{ marginTop: "-5%", zIndex: "1", border: "2px solid #C5C5C5", borderRadius: "10px",
              // marginRight: "6%", marginLeft: "10%", height: "10rem", width: "18rem",
              // width:"14rem"
            }}>
          ...
          >
            <div className="d-flex">
              <div>Balance :</div>
              <div style={{ marginLeft: "60%" }}>{balance}</div>
            </div>
          </div>
          <div
            style={{
